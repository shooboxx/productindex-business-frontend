    ...
    <>
      <div className="side-by-side">
        ...
        <div className={styles.inventorySection}>
          ...
          <Link href='#'><a className={`btn-primary btn ${styles.inventoryBtn}`}>+ Add items</a></Link>
          </div>

          <InventoryTable data = {[{productName: 'Hello', productType:'Service', imageUrl:'/', quantity:10, description:'This is a description', price:10.00, showPrice:true}]}/>
        </div>
