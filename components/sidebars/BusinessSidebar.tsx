    ...
    <div>
      <div className={styles.bizSidebar}>
        ...
        <div className={styles.sideBarSection}>
          ...
          <Link href={addStoreLink}>
            <a className={`link ${styles.itemPadding}`}>+ Add new store</a>
          </Link>
        </div>
        <div className={`${styles.manageBusiness} ${styles.sideBarSection}`}>
          <h6 className={`label ${styles.sideBarLabel}`}>Manage store</h6>
          <Link href={storeDetailsLink}>
            <a className={styles.navSelector}>Details</a>
          </Link>
          <Link href={storeInventoryLink}>
            <a className={styles.navSelector}>Inventory</a>
          </Link>
          <Link href={storeReviewsLink}>
            <a className={styles.navSelector}>Reviews</a>
          </Link>
        </div>
        <div className={styles.sideBarSection}>
          <Link href={manageBusinessLink}>
            <a className={styles.navSelector}>Manage Business</a>
          </Link>
          <Link href={manageBusinessProductLink}>
            <a className={styles.navSelector}>Business Products</a>
          </Link>
        </div>
        <div className={styles.sideBarSection}>
          <Link href={helpLink}>
            <a className={styles.navSelector}>Help</a>
          </Link>
        </div>
      </div>
    </div>
